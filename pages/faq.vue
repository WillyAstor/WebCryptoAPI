    ...
    <div class="max-w-screen-lg w-full p-10 bg-white rounded-xl z-10 shadow-xl dark:bg-gray-800">
      ...
      <ul>
        ...
        <li class="dark:text-gray-200">
          ...
          <a
            href="https://filecoin.xyz/"
            target="_external"
            class="text-blue-500 dark:text-blue-300"
            >FileCoin</a
          >
          deals and distribute them using
          <a href="https://ipfs.xyz/" target="_external" class="text-blue-500 dark:text-blue-300"
            >IPFS</a
        ...
        <li class="dark:text-gray-200">
          ...
          <a
            href="https://github.com/2file/2file"
            target="_external"
            class="text-blue-500 dark:text-blue-300"
            >GitHub repository</a
          >
        ...
        <li class="dark:text-gray-200">
          <b>A:</b> There are none, 2file is free to use and modify to suit
